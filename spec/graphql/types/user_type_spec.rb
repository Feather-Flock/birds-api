  ...
  describe '.user_events(id:)' do
    it 'returns a users created events' do
      ...
      @event1 = @user1.events.create(title: 'Lunch at Denison Park',
                                     description: 'We are getting together for a meet-and-greet at Denison Park.', time: '18:00:00', date: '2022-10-09', lat: '39.733', lng: '-104.904', address: '1105 Quebec St', city: 'Denver', state: 'CO', zip: 80_220, host: @user1.id)
  ...
  describe '.rsvpd_events(id:)' do
    it 'returns all events user has rsvpd to' do
      ...
      @event2 = @user2.events.create(title: 'Games at Verbena', description: 'Games at Verbena Park', time: '18:00:00',
                                     date: '2022-09-15', lat: '39.650', lng: '-104.893', address: '1151 Verbena St', city: 'Denver', state: 'CO', zip: 80_220, host: @user2.id)
  ...
  describe '.near_events(id:)' do
    it 'returns events in zipcode on users profile' do
      ...
      @event3 = @user3.events.create(title: 'Birthday Party at Montclair',
                                     description: "We will be celebrating Steven's 11th birthday!", time: '18:00:00', date: '2022-10-20', lat: 39.735, lng: -104.908, address: '6820 E 12th Ave', city: 'Denver', state: 'CO', zip: 80_220, host: @user3.id)
