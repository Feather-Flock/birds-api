...
RSpec.describe Types::UserType, type: :request do 
  describe '.user(id:)' do 
    it 'returns all details of a user' do 
      @user = User.create(user_name: "Garnet", email: "garnet@universe.com", image: "https://image.png" , description: "We are a married lesbian couple with kids. We love to play sports and go on adventures!" , zip_code: 80220)   
