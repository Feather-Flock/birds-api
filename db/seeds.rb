...
user4 = User.create(user_name 'Bubblegum', email: 'Pbgum@adventuretime.com',
                    'https://imgix.ranker.com/user_node_img/50128/1002557241/original/1002557241-photo-u1?auto=format&q=60&fit=crop&fm=pjpg&dpr=2&w=650', description: 'We are a lesbian couple with 1 beautiful daughter.', zip_code: 80005, lat: '39.86', lng: '-105.11')
user5 = User.create(user_name 'Velma', email: 'velma@scooby.com',
                    'https://static.wikia.nocookie.net/scoobydoo/images/9/9d/Velma_Dinkley.png/revision/latest?cb=20201229021337', description: 'Single non-binary mom with 4 y/o twins, look forward to events!', zip_code: 80021, lat: '39.91', lng: '-105.12')
user6 = User.create(user_name 'Smithers', email: 'smithers@simpsons.com',
                    'https://static.wikia.nocookie.net/simpsons/images/2/20/Smithersdolls.jpg/revision/latest/scale-to-width-down/640?cb=20191031042110', description: 'Single father of 1, looking to meet other LGBT+ families.', zip_code: 80041, lat: '39.73', lng: '-105.17')
...
event4 = user4.events.create(title: 'Animal Antics at City Park',
                             description: 'Bring your animals, with or without fur, for a fun time at the park.', time: '12:00:00', date: '2022-10-11', lat: '39.745', lng: '-104.957', address: '2500 E 23rd Ave', city: 'Denver', state: 'CO', zip: 80205, host: user4.id)
...
event10 = user4.events.create(title: 'Saturday Sports Watch Party',
                             description: 'We are meeting at Sloans Lake to walk around then have lunch nearby.', time: '10:00:00', date: '2022-10-17', lat: '39.752', lng: '-105.053', address: '2501 Sheridan Boulevard', city: 'Edgewater', state: 'CO', zip: 80214, host: user10.id)
